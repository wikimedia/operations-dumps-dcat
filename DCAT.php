 ...
 * @param array $dumps: array generated by scanDump()
...
/**
 * Given a dump directory this idenitifies dump files (if any) and
 * creates DCAT.rdf in the same directory
 */
function run($dirname){
    ...
    // create xml string based on
    $xml = outputXml(scanDump($dirname));

    file_put_contents($dirname.'/dcatap.rdf', $xml);
}
?>
